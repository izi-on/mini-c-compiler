...
# LOADING ARG: INT
# GETTING  VALUE
# Original instruction: addi v7,$zero,4
addi $t1,$zero,4
# VALUE CAUGHT
# Original instruction: addiu $sp,$sp,-4
addiu $sp,$sp,-4
...
sw $t0,0($t1)
# Original instruction: addi v12,$zero,1234
addi $t1,$zero,1234
# Original instruction: addiu v13,$fp,-12
addiu $t0,$fp,-12
# Original instruction: lw v14,0(v13)
lw $t0,0($t0)
# Loading from v12 from reg into v14
# Original instruction: sw v12,0(v14)
sw $t1,0($t0)
...
addi $t4,$sp,0
# 
# Loading from v16 from stack into v17
# Original instruction: li v18,4
li $t5,4
# Original instruction: li v19,0
li $t1,0
label_27_mem_copy_loop:
# Original instruction: beq v19,v18,label_28_mem_copy_end
beq $t1,$t5,label_28_mem_copy_end
# Original instruction: add v20,v16,v19
add $t2,$t0,$t1
# Original instruction: lb v22,0(v20)
lb $t3,0($t2)
# Original instruction: add v21,v17,v19
add $t2,$t4,$t1
# Original instruction: sb v22,0(v21)
sb $t3,0($t2)
# Original instruction: addi v19,v19,1
addi $t1,$t1,1
# Original instruction: j label_27_mem_copy_loop
j label_27_mem_copy_loop
label_28_mem_copy_end:
# 
# SPACE FOR RETURN VALUE
